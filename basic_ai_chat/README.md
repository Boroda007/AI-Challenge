...
### `POST /api/chat`
Принимает одно сообщение, общую историю диалога и ограничения генерации. Выполняет один вызов LLM и возвращает один ответ.
...
> **Примечания:**
> - Системный промпт добавляется в `conversation_history` как сообщение с ролью `system` и не входит в `constraints`.
